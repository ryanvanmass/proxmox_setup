...
# Copyright (c) 2025
# Author: Ryan Van Massenhoven (ryanvanmass)
# Credit: https://github.com/community-scripts/ProxmoxVE/blob/main/misc/post-pve-install.sh
...
EOF
  ...
  CHOICE=$(whiptail --backtitle "Proxmox VE Helper Scripts" --title "Storage" --menu "\nConfigure Fstab for the following Network Shares?\n/mnt/pve/ISO\mnt\pve/VM-Storage" 11 58 2 \
    "yes" " " \
    "no" " " 3>&2 2>&1 1>&3)
  case $CHOICE in
  yes)
